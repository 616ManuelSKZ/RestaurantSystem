                    ...
                    <form method="POST" action="{{ route('users.update', $user) }}">
                        ...
                        <div class="mt-4">
                            ...
                            <select name="rol" id="rol" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
                                <option value="administrador" {{ old('rol', $user->rol) == 'administrador' ? 'selected' : '' }}>Adminintrador</option>
                        ...
                        <div class="mt-4">
                            ...
                            <p class="text-sm text-gray-600">Dejar en blanco si no deseas cambiar la contraseña</p>
                        </div>
                        <!-- Confirm Password -->
                        <div class="mt-4">
