        ...
        <div class="max-w-4xl mx-auto bg-white dark:bg-background-dark/50 shadow-sm rounded-xl border border-primary/20 dark:border-primary/30 p-6">
            ...
            <form action="{{ route('facturas.store') }}" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        <label for="nombre_cliente" class="block text-gray-700 dark:text-gray-300 font-semibold mb-1">Nombre / Razón Social</label>
                    ...
                    <div>
                        <label for="nit_cliente" class="block text-gray-700 dark:text-gray-300 font-semibold mb-1">NIT / ID Fiscal</label>
                    ...
                    <div>
                        <label for="direccion_cliente" class="block text-gray-700 dark:text-gray-300 font-semibold mb-1">Dirección</label>
                    ...
                    <div>
                        <label for="telefono_cliente" class="block text-gray-700 dark:text-gray-300 font-semibold mb-1">Teléfono</label>
