<x-app-layout>
    ...
    <main class="flex-1 p-8 bg-gray-50 dark:bg-background-dark/20 min-h-screen">
        ...
        <div
            class="bg-white dark:bg-background-dark/50 shadow-sm rounded-xl border border-primary/20 dark:border-primary/30 p-6">
                ...
                <table class="w-full text-sm text-left border-collapse">
                    ...
                    <tbody class="divide-y divide-primary/10 dark:divide-primary/20">
                        ...
                        <tr class="hover:bg-primary/5 dark:hover:bg-primary/10 transition">
                            ...
                            <td class="px-6 py-4 text-center text-gray-700 dark:text-gray-300">{{ $detalle->cantidad }}
                            </td>
            ...
            <div class="mt-6 text-right">
                ...
                <p class="text-gray-700 dark:text-gray-300">Impuestos (13%):
                    ${{ number_format($factura->impuestos, 2) }}</p>
                <p class="text-lg font-semibold text-gray-900 dark:text-white">Total:
                    ${{ number_format($factura->totaliva, 2) }}</p>
            </div>
